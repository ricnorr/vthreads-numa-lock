...
cd fatjar
java -XX:+UseParallelGC -XX:+UseNUMA -XX:-RestrictContended --add-opens java.base/java.lang=ALL-UNNAMED  --enable-preview -Djdk.trackAllThreads=true  -Djna.library.path=../libs/ -jar NUMA-aware-locks.jar
