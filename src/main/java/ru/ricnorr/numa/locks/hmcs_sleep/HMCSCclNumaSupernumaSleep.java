 ...
 */
public class HMCSCclNumaSupernumaSleep extends AbstractHMCSSleep<HMCSQNodeSleepSleep> {

    public HMCSCclNumaSupernumaSleep() {
        ...
        for (int i = 0; i < Utils.NUMA_NODES_CNT; i++) {
            numaNodes.add(new HNode(superNumaNodes.get(i / 2), new HMCSQNodeSleepSleep()));
        }
