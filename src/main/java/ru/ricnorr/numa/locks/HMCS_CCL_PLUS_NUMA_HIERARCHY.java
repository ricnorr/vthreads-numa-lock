...
import static ru.ricnorr.numa.locks.HMCS_CCL_PLUS_NUMA_HIERARCHY.QNode.*;

/**
 * Сначала берем лок на CCL, затем берем лок на нума ноде, затем берем глобальный
 */
public class HMCS_CCL_PLUS_NUMA_HIERARCHY extends AbstractLock {
    ...
    public HMCS_CCL_PLUS_NUMA_HIERARCHY(boolean overSubscription) {
