...
import static ru.ricnorr.numa.locks.HMCS_ONLY_CCL_HIERARCHY_WITH_PADDING.QNode.*;

public class HMCS_ONLY_CCL_HIERARCHY_WITH_PADDING extends AbstractLock {
    ...
    public HMCS_ONLY_CCL_HIERARCHY_WITH_PADDING(boolean overSubscription) {
