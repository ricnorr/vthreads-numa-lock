 ...
 */
public class NumaMCSNoContended implements VthreadNumaLock<NumaMCSNoContended.UnlockInfo> {
  ...
  final List<AtomicReference<NumaMCSNoContended.Node>> localQueues;
